        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu" :class="{ 'nav-light': navLight === true }">
            ...
            <!-- <li>
              ...
              to="/index-corporate"
              class="side-nav-link-ref"
              >main page-logo</router-link>
            </li> -->
            <li>
              <router-link to="/shop-lists" class="side-nav-link-ref">Экспресс тесты на COVID-19</router-link>
            </li>
            <li class="has-submenu">
              <a href="javascript:void(0)" @click="onMenuClick">Деятельность</a><span class="menu-arrow"></span>
              <ul class="submenu">
                <li>
                  <router-link to="/page-history" class="side-nav-link-ref">О компании</router-link>
                </li>
                <li>
                  <router-link to="/page-services" class="side-nav-link-ref">Партнеры и Клиенты</router-link>
                </li>
                <li>
                  <router-link to="/page-aboutus" class="side-nav-link-ref">Команда</router-link>
                </li>
              </ul>
            </li>
            <li>
              <router-link to="/page-contact-two" class="side-nav-link-ref">Контакты</router-link>
            </li>
            <li>
              <router-link to="/page-blog-grid" class="side-nav-link-ref">Пресс-центр</router-link>
            </li>
          </ul>
          <!--end navigation menu-->
