              ...
              <ul class="submenu megamenu">
                <li>
                  <ul>
                    ...
                    <li>
                      <router-link to="/index-it-solution" class="side-nav-link-ref">IT Solution
                      </router-link>
                    </li>
                    <li>
                    ...
                    <li>
                      <router-link to="/index-corporate" class="side-nav-link-ref">Corporate Business</router-link>
                    </li>
                    <li>
                ...
                <li>
                  <ul>
                    <li>
                      <router-link to="/index-developer" class="side-nav-link-ref">Developer
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-seo-agency" class="side-nav-link-ref">Seo Egency
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-construction" class="side-nav-link-ref">Construction
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-real-estate" class="side-nav-link-ref">
                        Real Estate
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-hospital" class="side-nav-link-ref">
                        Hospital
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-integration" class="side-nav-link-ref">
                        Integration
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-landing-four" class="side-nav-link-ref">
                        Landing Four
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-task-management" class="side-nav-link-ref">Task Management
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-email-inbox" class="side-nav-link-ref">Email Inbox
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-landing-one" class="side-nav-link-ref">Landing One
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-landing-two" class="side-nav-link-ref">Landing Two
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-landing-three" class="side-nav-link-ref">Landing Three
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-travel" class="side-nav-link-ref">Travel
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/index-blog" class="side-nav-link-ref">Blog
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/forums" class="side-nav-link-ref">Forums
                      </router-link>
                    </li>
                    <li>
                ...
                <li>
                  <ul>
                    <li>
                      <router-link to="/index-shop" class="side-nav-link-ref">Shop
                        <span class="badge badge-pill badge-info">Updated</span></router-link>
                    </li>
                    <li>
                    ...
                    <li>
                      <router-link to="/index-onepage" class="side-nav-link-ref">Saas
                        <span class="badge badge-pill badge-warning ml-2">Onepage</span></router-link>
                    </li>
                  </ul>
                </li>
              </ul>
              ...
              <ul class="submenu">
                <li class="has-submenu"> 
                  ...
                  <ul class="submenu">
                    ...
                    <li>
                      <router-link to="/page-aboutus-two" class="side-nav-link-ref">
                        About Us Two
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                      <router-link to="/page-services" class="side-nav-link-ref">Services</router-link>
                    </li>
                    <li>
                      <router-link to="/page-history" class="side-nav-link-ref">History
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick"> Account </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link to="/account-profile" class="side-nav-link-ref">Profile</router-link>
                    </li>
                    <li>
                      <router-link to="/account-members" class="side-nav-link-ref">Members
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                      <router-link to="/account-works" class="side-nav-link-ref">Works
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                      <router-link to="/account-messages" class="side-nav-link-ref">Messages
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                      <router-link to="/account-payments" class="side-nav-link-ref">Payments
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Shop
                    <span class="badge badge-pill badge-success">Added</span> </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link to="/shop-grids" class="side-nav-link-ref">Product Grids</router-link>
                    </li>
                    <li>
                      <router-link to="/shop-lists" class="side-nav-link-ref">Product List
                        <span class="badge badge-pill badge-danger">New</span></router-link>
                    </li>
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Help center </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick"> Forums </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link to="/forums" class="side-nav-link-ref">Overview
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/forums-topic" class="side-nav-link-ref">Forum Topic
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/forums-comments" class="side-nav-link-ref">Forum Comments
                      </router-link>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Email Template</a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">Careers
                    <span class="badge badge-success rounded">Added</span> </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link tag="a" to="/page-jobs" class="side-nav-link-ref">Jobs</router-link>
                    </li>
                    <li>
                      <router-link tag="a" to="/page-jobs-sidebar" class="side-nav-link-ref">Jobs - Sidebar
                      </router-link>
                    </li>
                    <li>
                    ...
                    <li>
                      <router-link to="/page-job-company-list" tag="a" class="side-nav-link-ref">Company Listing
                        <span class="badge badge-pill badge-danger">New</span></router-link>
                    </li>

                    <li>
                      <router-link to="/page-job-company" class="side-nav-link-ref">Company Detail</router-link>
                    </li>
                    <li>
                      <router-link tag="a" to="/page-job-candidate-list" class="side-nav-link-ref">
                        Candidate Listing
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/page-job-candidate" class="side-nav-link-ref">Candidate Detail</router-link>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick"> Blog </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                    ...
                    <li>
                      <router-link to="/page-blog-list-sidebar" class="side-nav-link-ref">Blog List & Sidebar
                      </router-link>
                    </li>
                    <li>
                    ...
                    <li>
                      <router-link to="/page-blog-detail-two" class="side-nav-link-ref">Blog Detail 2
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Case Study </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link to="/page-cases" class="side-nav-link-ref">All Cases
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                    <li>
                      <router-link to="/page-case-detail" class="side-nav-link-ref">Case Detail
                        <span class="badge badge-success rounded">New</span></router-link>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Portfolio</a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                      <router-link to="/page-portfolio-modern" class="side-nav-link-ref">Portfolio Modern</router-link>
                    </li>
                    <li>
                      <router-link to="/page-portfolio-classic" class="side-nav-link-ref">Portfolio Classic
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/page-portfolio-grid" class="side-nav-link-ref">Portfolio Grid</router-link>
                    </li>
                    <li>
                      <router-link to="/page-portfolio-masonry" class="side-nav-link-ref">Portfolio Masonry
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/page-portfolio-detail" class="side-nav-link-ref">Portfolio Detail</router-link>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick">
                    Auth Pages</a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick"> Utility </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
                ...
                <li class="has-submenu">
                  ...
                  <ul class="submenu">
                    ...
                    <li>
                      <router-link to="/page-thankyou" class="side-nav-link-ref">Thank you
                        <span class="badge badge-pill badge-danger">New</span>
                      </router-link>
                    </li>
                  </ul>
                ...
                <li class="has-submenu">
                  <a href="javascript:void(0)" @click="onMenuClick"> Contact </a><span class="submenu-arrow"></span>
                  <ul class="submenu">
                    <li>
